...
@section('title', "Quick Delivery | OneStall Cargo")

@section('content')
<section class="bg-brand-navy py-10 text-center">
    <div class="max-w-4xl mx-auto px-4">
        <h1 class="text-4xl md:text-5xl font-extrabold text-white mb-6">Quick Delivery</h1>
        <p class="text-xl text-gray-300">Hyperlocal and same-day express delivery services.</p>
    </div>
</section>
...
<section class="py-12 bg-white">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="grid grid-cols-1 md:grid-cols-2 gap-8 items-center">
            <div>
                <h2 class="text-3xl font-bold text-gray-900 mb-6">Robust Quick Delivery Capabilities</h2>
