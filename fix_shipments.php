...
$content = str_replace(
    '<a href="{{ route(\'seller.label\', $shipment->awb_number) }}" target="_blank" class="block px-4 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50">Edit Order</a>',
...
$content = str_replace('@endsection', $modals, $content);
